...
let mercurySystem = system.mercury.mass;
console.log(mercurySystem);

// 2. console.log the eccentricity of Venus

let venusSystem = system.venus.eccentricity;

console.log(venusSystem);

// 3. console.log the sum of the number of satellites of Jupiter, Saturn, Uranus, and Neptune

let systemSatellites = [];

systemSatellites.push(system.jupiter.satellites);
systemSatellites.push(system.uranus.satellites);
systemSatellites.push(system.saturn.satellites);
systemSatellites.push(system.neptune.satellites);
console.log(systemSatellites);

let sum = 0;
systemSatellites.forEach((el) => (sum += Number(el)));
console.log(sum);
...
let radiusMercury = system.mercury.radiusp;
console.log(radiusMercury);
if (typeof radiusMercury !== String) {
  radiusMercury = system.mercury.radiuse;
...
let jupiterVM = system.jupiter.velocity * system.jupiter.mass;
let plutoVM = system.pluto.velocity * system.pluto.mass;

let planetDifference = jupiterVM - plutoVM;
console.log(planetDifference);
